...
class _FilterPageState extends State<FilterPage> {
  ...
  Future<void> fetchItems() async {
    ...
    final url = Uri.parse("https://pakailagi.user.cloudjkt02.com/api/products/kategori");
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({"kategori": widget.value}),
      );
      ...
      debugPrint("Error fetching filtered items: $e");
    }
  }
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: items == null
              ...
              : items!.isEmpty
              ? Center(child: Text("Produk kategori ${widget.value} kosong"))
              : GridView.builder(
